...
/**
 * Created by xsquare on 2018/3/20.
 */
...
/**
 * 这个类封装了滚动功能，可以超越滚动操作的边界。
 * 这个类在大多数情况下替代了{@link android.widget.Scroller}。
 */
public class OverScroller {
     ...
     * @param interpolator 滑动的插值器. If null, a default (viscous) interpolator will
     * be used.
     * @param flywheel 如果true，连续的投掷动作将继续提高滚动速度。
     */
    ...
    public boolean computeScrollOffset() {
        ...
        switch (mMode) {
            case SCROLL_MODE:
                ...
                // Any scroller can be used for time, since they were started together in scroll mode. We use X here.
    ...
    /**
     * 返回滚动器是否完成滚动。
     * @return 如果滚动器已完成滚动，则为true，否则为false
     */
